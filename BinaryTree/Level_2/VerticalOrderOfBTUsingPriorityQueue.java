...
public class VerticalOrderOfBTUsingPriorityQueue {
    ...
    public List<List<Integer>> verticalTraversal(TreeNode root) {
        ...
        PriorityQueue<vPair> mq = new PriorityQueue<>((a,b) -> {
            return a.node.val - b.node.val;
        });
        PriorityQueue<vPair> cq = new PriorityQueue<>((a,b) -> {
            return a.node.val - b.node.val;
        });
        ...
        while (mq.size() > 0) {
            ...
            while (qSize-- > 0) {
                ...
                if (rp.node.left != null) {
                    cq.add(new vPair(rp.node.left, rp.hl - 1));
                }

                if (rp.node.right != null) {
                    cq.add(new vPair(rp.node.right, rp.hl + 1));
                }
            }
            
            // SWAP 
            PriorityQueue<vPair> temp = mq;
            mq = cq;
            cq = temp;
        }
        return ans;
